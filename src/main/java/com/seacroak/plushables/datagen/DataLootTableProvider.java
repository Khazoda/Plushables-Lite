...
public class DataLootTableProvider extends FabricBlockLootTableProvider {
    public DataLootTableProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
...
//        addDrop(MainRegistry.BASKET_BLOCK);
        ...
        addDrop(MainRegistry.STATUETTE_PLUSHABLE);
        addDrop(MainRegistry.MAMMOTH_PLUSHABLE);
        addDrop(MainRegistry.TIGER_PLUSHABLE);
        addDrop(MainRegistry.WALRUS_PLUSHABLE);
        addDrop(MainRegistry.BLAHAJ_PLUSHABLE);
        addDrop(MainRegistry.WISP_PLUSHABLE);
        addDrop(MainRegistry.COOPER_PLUSHABLE);
        addDrop(MainRegistry.ZIGGY_PLUSHABLE);
        addDrop(MainRegistry.POTSY_PLUSHABLE);
